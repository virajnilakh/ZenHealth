...
this script is for query 5, main dishes in course , sugar value is high, allowed allergy: peanut, allowedDiet=Lacto-ovo vegetarian
'''                  
                     
def getRecipeData():
    recipeUrlList = [
                     'http://api.yummly.com/v1/api/recipe/Pale-Ale-Grainy-Beer-Mustard-2052800?_app_id=dummyid&_app_key=dummykey'
                     ]
