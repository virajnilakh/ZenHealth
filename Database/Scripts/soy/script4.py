...
this script is for query 4, Main Dishes in course , sugar value is high, allowed allergy: soy, allowedDiet= Vegan
'''                  
                     
def getRecipeData():
    recipeUrlList = [
                     'http://api.yummly.com/v1/api/recipe/Leek-And-Potato-Bake-2006909?_app_id=dummyid&_app_key=dummykey'
                     ]
