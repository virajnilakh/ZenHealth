...
def getRecipeData():
    recipeUrlList = [
                     'http://api.yummly.com/v1/api/recipe/Peanut-Butter-Banana-Smoothie-2123192?_app_id=dummyid&_app_key=dummykey',
                     'http://api.yummly.com/v1/api/recipe/Cheese-Garlic-Biscuits-2058237?_app_id=dummyid&_app_key=dummykey',
                     'http://api.yummly.com/v1/api/recipe/Perfect-Pecan-Pie-517679?_app_id=dummyid&_app_key=dummykey',
                     'http://api.yummly.com/v1/api/recipe/Creme-Brulee-French-Toast-1624644?_app_id=dummyid&_app_key=dummykey'
                     ]
