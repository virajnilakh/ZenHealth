...
this script is for query 6, Main Dishes in course , sugar value is high, allowed allergy: soy, allowedDiet= Non vegetarian; allowedIngredient = chicken
'''                  
                     
def getRecipeData():
    recipeUrlList = [
                     'http://api.yummly.com/v1/api/recipe/Gooey-Potatoes-2416257?_app_id=dummyid&_app_key=dummykey'
                     ]
