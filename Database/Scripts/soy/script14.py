...
this script is for query 14, Main Dishes in course , sugar value is high, allowed allergy: soy, allowedDiet= Vegan
'''                  
                     
def getRecipeData():
    recipeUrlList = [
                     'http://api.yummly.com/v1/api/recipe/Vegan-Mini-Blueberry-Pavlovas-2414683?_app_id=dummyid&_app_key=dummykey'
                     ]
