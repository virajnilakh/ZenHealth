...
this script is for query 4, main dishes in course , sugar value is low, allowed allergy: gluten, allowedDiet= vegan
'''                  
                     
def getRecipeData():
    recipeUrlList = [
                     'http://api.yummly.com/v1/api/recipe/Classic-Ratatouille-1108013?_app_id=dummyid&_app_key=dummykey'
                     ]
