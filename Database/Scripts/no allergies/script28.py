...
this script is for query 28, lunch in course , sugar value is high, allowed allergy: none, allowedDiet=Non Vegetarian; ['allowedIngredient']= 'pork' 
'''                  
                     
def getRecipeData():
    recipeUrlList = [
                     'http://api.yummly.com/v1/api/recipe/Zucchini-Slice-2311474?_app_id=dummyid&_app_key=dummykey'
                     ]
