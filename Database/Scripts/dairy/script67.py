...
this script is for query 67, Lunch and salads in course , sugar value is medium, allowed allergy: dairy, allowedIngredient=beef
'''                  
                     
def getRecipeData():
    recipeUrlList = [
                     'http://api.yummly.com/v1/api/recipe/Healthy-Homemade-Sloppy-Joes-1635849?_app_id=dummyid&_app_key=dummykey'
                     ]
