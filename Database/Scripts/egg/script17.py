...
this script is for query 17, lunch in course , sugar value is high, allowed allergy: egg, allowedDiet=Non vegetarian; allowedIngredient[]=chicken
'''                  
                     
def getRecipeData():
    recipeUrlList = [
                     'http://api.yummly.com/v1/api/recipe/Mango-Guacamole-Chicken-Wraps-1221284?_app_id=dummyid&_app_key=dummykey'
                    ]
